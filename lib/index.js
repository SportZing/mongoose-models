...
exports.init = function(conf) {
	...
	exports.create = function(name, props) {
		...
		// Extend mongoose model with the paginate method...
		...
		// Added collection name in case model pluralization is not enough...
		...
		Object.keys(props).forEach(function(i) {
			if (i !== 'schema' && i !== 'collection' && i !== 'useTimestamps' && i !== 'methods') {
				model[i] = props[i];
			}
		});
